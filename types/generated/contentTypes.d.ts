...
export interface PluginTruckTrackerTruck extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    key: Schema.Attribute.String & Schema.Attribute.Required & Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'plugin::truck-tracker.truck'> &
      Schema.Attribute.Private;
    model: Schema.Attribute.Enumeration<
      ['Toyota Corolla', 'Toyota RAV4', 'Ford F-Series', 'Honda CR-V', 'Dacia Sandero']
    > &
      Schema.Attribute.Required;
    position: Schema.Attribute.JSON & Schema.Attribute.CustomField<'global::geo-picker'>;
    positionUpdatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'plugin::truck-tracker.truck': PluginTruckTrackerTruck;
